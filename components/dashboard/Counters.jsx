...
today = dd + '/' + mm + '/' + yyyy;
      ...
      const isOpenToday = (value) => value.status =="open" && value.updated  ==today;
      const isClosedToday = (value) => value.status == "closed"&& value.updated ==today;
  ...
  return (
    ...
    <div className = "bg-green-700 w-40 text-center	 border rounded-lg border-slate-700 h-20 text-xl">
    Total Closed
    <br/> 
    {closed.length}
  </div>
