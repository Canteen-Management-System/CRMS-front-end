...
export default class AddPriority extends Form {
  constructor(props) {
    super(props);
  }
  state = {
  ...
  render() {
    this.doSubmit = async () => {
      try {
        await http.post("/priority-list", this.state.data, auth.config);
    ...
    return (
      <div>
        <Modal modalTitle="Add new priority" animation={this.props.animation}>
