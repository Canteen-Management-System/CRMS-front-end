...
export default function Category({ toggleAddForm, toggleViewCategories }) {
  return (
    <div className="flex flex-row items-center justify-around w-1/2 mx-4 ">
      <h3 className="text-4xl font-thin text-white">Category</h3>
