...
export default class AddDepartment extends Form {
  constructor(props) {
    super(props);
  }
  state = {
  ...
  render() {
    this.doSubmit = async () => {
      try {
        await http.post("/department-list", this.state.data, auth.config);
    ...
    return (
      <div>
        <Modal modalTitle="Add new department" animation={this.props.animation}>
